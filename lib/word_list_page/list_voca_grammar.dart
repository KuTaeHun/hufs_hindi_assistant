...
class word_list_voca_grammar extends StatefulWidget {
  //단어 레벨 타이틀
  String page_name;
  String file_name;
  ...
  @override
  _word_list_vocaState_grammar createState() => _word_list_vocaState_grammar(
      start_word_num, finish_word_num, page_name, file_name);
}

class _word_list_vocaState_grammar extends State<word_list_voca_grammar> {
  //단어 레벨 타이틀
  String page_name;
  String file_name;
                                  ...
                                  child: Card(
                                    ...
                                    child: ListTile(
                                      ...
                                      subtitle: AutoSizeText(
                                        '('+snapshot.data[index][2]+')  '+snapshot.data[index][3],
                                        style: TextStyle(

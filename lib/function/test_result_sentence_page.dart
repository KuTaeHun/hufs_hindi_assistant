...
class _test_sentence_resultState extends State<test_sentence_result> {
  ...
  _fixCorrect(int this_page_correct) async{
    ...
    setState(() {
      if ((wordlist.getInt('total_sentence_correct')) == null) {
        (wordlist.setInt('total_sentence_correct', this_page_correct));


      }
      else{
        current_correct = wordlist.getInt('total_sentence_correct');
        current_correct += this_page_correct;
        wordlist.setInt('total_sentence_correct', current_correct);
      }
  ...
  _fixTotalCount(int this_page_total) async{
    ...
    int current_total =0;
    setState(() {
      if ((wordlist.getInt('total_sentence')) == null) {
        (wordlist.setInt('total_sentence', this_page_total));


      }
      else{
        current_total = wordlist.getInt('total_sentence');
        current_total = current_total+this_page_total;
        wordlist.setInt('total_sentence', current_total);
      }
  ...
  _fixGrade() async{
    ...
    setState(() {
      if((wordlist.getInt('total_sentence'))==null || (wordlist.getInt('total_sentence_correct'))==null)
      {
        ...
        if(0<=total_record_score && total_record_score<30)
